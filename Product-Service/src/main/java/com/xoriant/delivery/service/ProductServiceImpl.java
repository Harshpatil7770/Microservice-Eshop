...
public class ProductServiceImpl implements ProductService {
	...
	private static final String NEW_LISTS_OF_PRODUCT_ADDED = "New Product Lists Added Succesfully !";

	private static final String UPDATE_EXISTING_PRODUCT = "Update Existing update Product Succesfully !";

	private static final String UPDATE_LISTS_OF_PRODUCTS = "Update Lists Of Existing Products !";
	...
	public String addNewListsProducts(List<ProductDTO> productDTO, int brandId, int categoryId) {
		...
		return NEW_LISTS_OF_PRODUCT_ADDED;
	}
	...
	public String updateListsProduct(List<ProductDTO> productDTO, int brandId, int categoryId) {
		...
		return UPDATE_LISTS_OF_PRODUCTS;
	}
